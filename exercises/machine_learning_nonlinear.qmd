...
**Solutions:**
All solutions are provided in the book chapter [Option pricing via machine learning (R version)](https://tidy-finance.org/r/option-pricing-via-machine-learning.html) or [Option pricing via machine learning (Python version)](https://tidy-finance.org/python/option-pricing-via-machine-learning.html)