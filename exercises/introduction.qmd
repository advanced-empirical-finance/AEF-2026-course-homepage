...
## Working with stock market data {#working-with-stock-market-data}
...
## Scaling up the analysis {#scaling-up-the-analysis}
...
**Solutions:** All tasks are solved and described in detail in [Tidy Finance with R](https://www.tidy-finance.org/r/introduction-to-tidy-finance.html#portfolio-choice-problems) and [Tidy Finance with Python](https://www.tidy-finance.org/python/introduction-to-tidy-finance.html#portfolio-choice-problems), in the Chapters *Portfolio Choice Problems* and *The Efficient Frontier*.
  
## Equivalence between Certainty equivalent maximization and minimum variance optimization {#equivalence-between-certainty-equivalent-maximization-and-minimum-variance-optimization}
