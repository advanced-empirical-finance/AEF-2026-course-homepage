...
1. Load the monthly CRSP file, the Fama-French Factors, and the estimated betas from `crsp_monthly.parquet`, `factors_ff_monthly.parquet`, and `beta.parquet` in `data-r` / `data-python`.
