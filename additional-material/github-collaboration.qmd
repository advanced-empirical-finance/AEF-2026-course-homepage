...
2. Choose a name for your repository (e.g. *"AEF-Assignments-Group1"*). Add a description and set the visibility to "Private" (such that only you and your group members can access it). You do not need to initialize the repository with a README or .gitignore file. Click *"Create repository"*
